...
$diegoWindowsProduct = (gwmi Win32_Product -Filter "Name = 'DiegoWindows'")
if ($diegoWindowsProduct) { $diegoWindowsProduct.Uninstall() }

$gardenWindowsProduct = (gwmi Win32_Product  -Filter "Name = 'GardenWindows'")
if ($gardenWindowsProduct) { $gardenWindowsProduct.Uninstall() }


## Download installers

$gardenReleaseVersion="v0.131"
$diegoReleaseVersion="v0.387"
...
Install-WindowsFeature PowerShell, PowerShell-V2 

# Deps for cf-iis8-buildpack
Install-WindowsFeature Web-Net-Ext, Web-AppInit 
